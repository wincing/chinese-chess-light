...
var a, o, c, u, l, h, f, _, d, p, v, g, m, y, A = (a = t(r, i - 1), o = t(r, i - 0), 
...
function c(t, e) {
var c, u, l, h, f = e - 0, _ = e - t[0], d = 3 * f, p = 3 * _, v = 3 * (e - t[2]), g = 1 / (-f + p - v + (e - 1)), m = (d - 6 * _ + v) * g, y = m * (1 / 3), A = (-d + p) * g, E = 1 / 3 * (3 * A - m * m), T = E * (1 / 3), C = (2 * m * m * m - 9 * m * A + f * g * 27) / 27, x = C / 2, b = x * x + T * T * T;
if (b < 0) {
var S = 1 / 3 * -E, R = a(S * S * S), w = -C / (2 * R), M = n(w < -1 ? -1 : w > 1 ? 1 : w), I = 2 * o(R);
u = I * i(M * (1 / 3)) - y;
l = I * i((M + s) * (1 / 3)) - y;
h = I * i((M + 2 * s) * (1 / 3)) - y;
...
"../core/assets/CCAudioClip": 49,
"../core/event/event-target": 96,
...
"./CCGame": 14,
"./CCScheduler": 18,
"./component-scheduler": 77,
"./event-manager": 94,
"./event/event-target": 96,
"./node-activator": 109,
...
t("./event/event-target")), h = t("./renderer/render-flow"), f = cc.Object.Flags.Destroying, _ = Math.PI / 180, d = !!cc.ActionManager, p = function() {}, v = new i.Vec3(), g = new i.Quat(), m = new i.Vec3(), y = new i.Vec3(), A = new i.Quat(), E = new i.Quat(), T = new i.Vec3(), C = new i.Vec3(), x = new i.Vec3(), b = new i.Vec3(), S = new i.Vec3(), R = new i.Quat(), w = new i.Quat(), M = new i.Vec3(), I = new i.Quat(), D = new i.Vec3(), O = new i.Quat(), L = new i.Vec3(), N = new i.Vec3(), P = new i.Quat(), F = new i.Quat(), B = (new i.Quat(), 
...
}), G = [ W.TOUCH_START, W.TOUCH_MOVE, W.TOUCH_END, W.TOUCH_CANCEL ], H = [ W.MOUSE_DOWN, W.MOUSE_ENTER, W.MOUSE_MOVE, W.MOUSE_LEAVE, W.MOUSE_UP, W.MOUSE_WHEEL ], j = !0, Y = function(t) {
if (0 !== t) {
...
up: {
get: function() {
return i.Vec3.transformQuat(D, i.Vec3.UP, this.getWorldRotation(O)).clone();
}
},
right: {
get: function() {
return i.Vec3.transformQuat(D, i.Vec3.RIGHT, this.getWorldRotation(O)).clone();
}
},
forward: {
get: function() {
return i.Vec3.transformQuat(D, i.Vec3.FORWARD, this.getWorldRotation(O)).clone();
}
}
},
ctor: function() {
...
var r = -1 !== G.indexOf(t), s = !r && -1 !== H.indexOf(t);
if (r || s) {
...
} else if (s && this._mouseListener && !nt(this, H)) {
...
if (this._mouseListener && !nt(this, H)) {
o.removeListener(this._mouseListener);
this._mouseListener = null;
}
},
...
i.Vec3.sub(t, t, m);
i.Trs.toRotation(A, n);
i.Quat.conjugate(E, A);
...
var e = this._trs;
this._parent ? this._parent._invTransformPoint(T, t) : i.Vec3.copy(T, t);
i.Trs.fromPosition(e, T);
this.setLocalDirty(V.ALL_POSITION);
1 & this._eventMask && this.emit(W.POSITION_CHANGED);
},
...
lookAt: function(t, e) {
this.getWorldPosition(M);
i.Vec3.sub(M, M, t);
i.Vec3.normalize(M, M);
i.Quat.fromViewUp(I, M, e);
...
"./platform/js": 131,
"./renderer/render-flow": 142,
"./utils/affine-transform": 165,
"./utils/base-node": 166,
"./utils/prefab-helper": 175,
"./utils/trans-pool": 181,
"./value-types": 187
} ],
16: [ (function(t, e) {
"use strict";
...
"./platform/id-generater": 127,
"./platform/js": 131
} ],
19: [ (function(t, e) {
"use strict";
var i = t("./preprocess"), n = t("./fetch"), r = t("./cache"), s = t("./helper"), a = t("./releaseManager"), o = t("./depend-util"), c = t("./load"), u = t("./pipeline"), l = t("./task"), h = t("./request-item"), f = t("./downloader"), _ = t("./parser"), d = t("./pack-manager"), p = t("./bundle"), v = t("./builtins"), g = t("./factory"), m = t("./urlTransformer"), y = m.parse, A = m.combine, E = t("./utilities"), T = E.parseParameters, C = E.asyncify, x = t("./shared"), b = x.assets, S = x.files, R = x.parsed, w = x.pipeline, M = x.transformPipeline, I = x.fetchPipeline, D = x.RequestType, O = x.bundles, L = x.BuiltinBundleName;
function N() {
...
this.transformPipeline = M.append(y).append(A);
this.bundles = O;
this.assets = b;
this._files = S;
this._parsed = R;
...
get resources() {
return O.get(L.RESOURCES);
},
get internal() {
return O.get(L.INTERNAL);
},
init: function(t) {
...
try {
for (var r = M.sync(i), s = 0, a = r.length; s < a; s++) {
var o = r[s], c = o.url;
o.recycle();
n.push(c);
}
...
"../platform/deserialize-compiled": 125,
"./cache": 22,
"./deserialize": 26,
"./shared": 44
} ],
...
i(null, t);
}, S = new l(), R = [], w = !1, M = 0, I = 0, D = -1, O = !1, L = function() {
var t = Date.now();
...
"../platform/utils": 134,
"./cache": 22,
"./download-dom-audio": 27,
"./download-dom-image": 28,
"./download-file": 29,
"./download-script.js": 30,
"./font-loader": 34,
"./shared": 44,
"./utilities": 47
} ],
...
var y, A, E, T, C, x, b = document.createElement("div"), S = b.style;
S.fontFamily = _;
b.innerHTML = ".";
S.position = "absolute";
S.left = "-100px";
...
for (var f = A.callbacks, g = 0, m = f.length; g < m; g++) {
var y = f[g];
e.addRef && e.addRef();
y.item.content = e;
y.done(t);
...
if (m && m.persistDeps) for (var y = m.persistDeps, A = 0, E = y.length; A < E; A++) {
var T = r.get(y[A]);
T && T.decRef(t.autoReleaseAssets);
}
i.remove(t._id);
}
},
...
var E = t.packs;
for (var T in E) for (var C = E[T], x = 0; x < C.length; ++x) C[x] = e[C[x]];
var b = t.versions;
...
m += e._isAbsLeft ? e._left : e._left * A;
...
var x = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * A, b = (.5 - _.x) * f.width;
if (l) {
x *= u.x;
b += c.x;
b *= u.x;
...
p = b + (T - .5) * E + x;
} else p = e.isAlignLeft ? m + T * E : y + (T - 1) * E;
}
}
if (e._alignFlags & n) {
var S, R, w = f.height;
...
var O = e._isAbsVerticalCenter ? e._verticalCenter : e._verticalCenter * w, L = (.5 - _.y) * f.height;
if (l) {
O *= u.y;
L += c.y;
L *= u.y;
...
v = L + (I - .5) * M + O;
} else v = e.isAlignBottom ? R + I * M : S + (I - 1) * M;
}
}
t.setPosition(p, v);
}
...
"../assets/material/CCMaterial": 66,
"../platform/CCMacro": 115,
"../renderer/utils/label/label-frame": 144,
"../renderer/utils/utils": 147,
"../utils/blend-func": 167,
...
"../assets/material/CCMaterial": 66,
"../assets/material/material-variant": 73,
...
"./CCAnimation": void 0,
"./CCAudioSource": 78,
"./CCBlockInputEvents": 79,
"./CCButton": 80,
"./CCCanvas": 81,
"./CCComponent": 82,
"./CCComponentEventHandler": 83,
"./CCLabel": 84,
...
"../value-types/mat3": 188,
"../value-types/vec3": 197,
"./enums": 101
} ],
101: [ (function(t, e, i) {
"use strict";
...
if (l) for (var v = 0, g = e.length / h; v < g; v++) for (var m = v * h, y = v * d + p, A = 0; A < h; A++) u[y + A] = e[m + A]; else {
var E;
E = t === i.default.ATTR_COLOR ? a : 2 === h ? o : c;
for (var T = 0, C = e.length; T < C; T++) E(u, T * d + p, e[T]);
}
r.vDirty = !0;
},
...
if (f.length > 0) {
for (var p = new DataView(i, r), v = n, g = c.num, m = 0; m < _; ++m) for (var y = m * g, A = 0; A < g; ++A) {
var E = y + A, T = v * m + d * A;
p[u](T, f[E], h);
}
s = !0;
...
"../../renderer/core/input-assembler": 203,
"../../renderer/gfx": 207,
"../event/event-target": 96,
"../renderer": 141,
"./mesh-data": 107
...
var l = e.type;
if (l) {
if (M[l]) (o || u())[c + "type"] = l; else if ("Object" === l) ; else if (l === s.ScriptUuid) {
(o || u())[c + "type"] = "Script";
...
var A = y(o), E = m(u, "requireComponent"), T = y(h), C = m(f, "executionOrder"), x = y(o), b = y(o), S = y(h), R = y(h), w = y(h);
...
A.pool = new n.default.Pool(function(t) {
t.reset();
}, 5);
A.pool.get = function() {
...
w[3] = b(S);
w[4] = R;
w[5] = function(t, e, i, n) {
g[n[0]](e[i], n);
};
w[6] = S;
w[7] = function(t, e, i, n) {
e[i].set(n);
};
...
"../value-types/color": 186,
"../value-types/mat4": 189,
"../value-types/quat": 190,
"../value-types/rect": 191,
"../value-types/size": 192,
"../value-types/vec2": 196,
"../value-types/vec3": 197,
"../value-types/vec4": 198,
"./js": 131
} ],
126: [ (function(t) {
"use strict";
...
"../utils/mutable-forward-iterator": 173,
"./id-generater": 127
} ],
132: [ (function(t, e, i) {
"use strict";
...
var v = r * l, g = r * h, m = s * l, y = s * h, A = a * f, E = a * _, T = o * f, C = o * _;
i[p] = v + A + c;
i[p + 1] = m + T + u;
i[p += d] = g + A + c;
i[p + 1] = y + T + u;
...
this.line = 0;
this.hash = "";
}, h = cc.rect(), f = null, _ = [], d = [], p = [], v = [], g = null, m = 0, y = 0, A = 0, E = 0, T = 0, C = 1, x = null, b = cc.size(), S = "", R = 0, w = 0, M = 0, I = 0, D = 0, O = 0, L = 0, N = !1, P = 0, F = 0, B = 0, z = (function(t) {
s(e, t);
function e() {
return t.apply(this, arguments) || this;
}
...
var A = S.charAt(v);
if ("\n" !== A) {
for (var x = t(S, v, e), R = l, w = h, M = o, I = n, z = !1, U = 0; U < x; ++U) {
var k = v + U;
if ("\r" !== (A = S.charAt(k))) if (f = u.fontAtlas.getLetterDefinitionForChar(A, u)) {
var V = I + f.offsetX * C - u.margin;
if (N && B > 0 && n > 0 && V + f.w * C > B && !a.isUnicodeSpace(A)) {
p.push(o);
o = 0;
i++;
n = 0;
...
d.x = V;
d.y = r - f.offsetY * C + u.margin;
this._recordLetterInfo(d, A, k, i);
k + 1 < _.length && k < e - 1 && (I += _[k + 1]);
I += f.xAdvance * C + D - 2 * u.margin;
M = d.x + f.w * C - u.margin;
R < d.y && (R = d.y);
w > d.y - f.h * C && (w = d.y - f.h * C);
} else {
this._recordPlaceholderInfo(k, A);
var W = "";
g && (W = g.atlasName);
console.log("Can't find letter definition in texture atlas " + W + " for letter:" + A);
} else this._recordPlaceholderInfo(k, A);
}
if (!z) {
n = I;
l < R && (l = R);
...
n = 0;
r -= O * this._getFontScale() + 0;
this._recordPlaceholderInfo(v, A);
v++;
}
}
p.push(o);
y = (m = i + 1) * O * this._getFontScale();
m > 1 && (y += 0 * (m - 1));
b.width = P;
b.height = F;
P <= 0 && (b.width = parseFloat(s.toFixed(2)) + 2 * u.margin);
F <= 0 && (b.height = parseFloat(y.toFixed(2)) + 2 * u.margin);
E = b.height;
T = 0;
if (L !== c.CLAMP) {
l > 0 && (E = b.height + l);
...
if (!s) return r;
for (var o = s.xAdvance * C + D, c = e + 1; c < i; ++c) {
n = t.charAt(c);
...
return N ? i > b.width && n : n;
};
i._updateQuads = function() {
var t = x ? x._texture : u.fontAtlas.getTexture(), e = f.node;
...
p - _.h * C < T && L === c.CLAMP && (h.height = p < T ? 0 : (p - T) / C);
}
var m = l.line, y = l.x + _.w / 2 * C + v[m];
...
this.appendQuad(f, t, h, R, w - n, p - r, C);
}
}
}
...
var s = b.height - y + O * this._getFontScale() - w * C;
I === o.VerticalTextAlignment.BOTTOM ? A -= s : A -= s / 2;
}
};
...
"../../../assets/CCRenderTexture": 56,
"../../../components/CCComponent": 82,
"../../../components/CCLabel": 84,
"../../../components/CCLabelOutline": void 0,
"../../../utils/text-utils": 179,
"../../webgl/assemblers/label/2d/bmfont": 149,
"../utils": 147
} ],
146: [ (function(t, e, i) {
"use strict";
...
var a, o = t("../../../utils/text-utils"), c = t("../../../platform/CCMacro"), u = t("../../../components/CCLabel"), l = t("../../../components/CCLabelOutline"), h = t("../../../components/CCLabelShadow"), f = u.Overflow, _ = t("../utils").deleteFromDynamicAtlas, d = t("../utils").getFontFamily, p = (1 / 255).toFixed(3), v = null, g = null, m = null, y = "", A = "", E = 0, T = 0, C = [], x = cc.Size.ZERO, b = 0, S = 0, R = 0, w = null, M = "", I = f.NONE, D = !1, O = !1, L = null, N = cc.Color.WHITE, P = null, F = cc.Color.BLACK, B = cc.rect(), z = cc.Size.ZERO, U = cc.Size.ZERO, k = !1, V = !1, W = !1, G = 0, H = cc.Vec2.ZERO, j = 0, Y = [ "left", "center", "right" ], X = (function(t) {
s(e, t);
function e() {
return t.apply(this, arguments) || this;
}
...
if (P || L || W) {
var i = C.length > 1 && P, n = this._measureText(v, y), r = 0, s = 0;
P && this._setupShadow();
...
s = t.y + a * e;
if (i) {
L && v.strokeText(C[a], r, s);
v.fillText(C[a], r, s);
}
if (W) {
j = n(C[a]);
S === c.TextAlignment.RIGHT ? H.x = t.x - j : S === c.TextAlignment.CENTER ? H.x = t.x - j / 2 : H.x = t.x;
H.y = s + T / 8;
v.fillRect(H.x, H.y, j, G);
}
}
...
v.lineJoin = "round";
if (O) v.fillStyle = "rgba(" + w.r + ", " + w.g + ", " + w.b + ", " + w.a / 255 + ")"; else {
var t = L ? N : w;
...
var _ = (x.width - B.width) / r, d = x.height / n;
E = T * Math.min(1, _, d) | 0;
y = this._getFontDesc();
v.font = y;
}
};
...
var h, f, _, d, p = e.width, v = e.height, g = i.width, m = i.height, y = this._getColor(t), A = this.floatsPerVert, E = a + this.uvOffset;
if (n) {
h = i.x / p;
_ = (i.x + m) / p;
f = (i.y + g) / v;
...
for (var T = a + this.colorOffset, C = 0; C < 4; C++) {
l[T] = y;
T += A;
}
...
var m = this._renderData.vDatas[0], y = this.uvOffset, A = this.floatsPerVert;
switch (t._fillType) {
case a.HORIZONTAL:
m[y] = s + (c - s) * e;
m[y + 1] = o + (u - o) * e;
...
h.length = f.length = 0;
var _, d, p = e.insetLeft, v = e.insetRight, g = i.width - p - v, m = e.insetTop, y = e.insetBottom, A = i.height - m - y, E = n.width / (p + v) > 1 ? 1 : n.width / (p + v), T = n.height / (m + y) > 1 ? 1 : n.height / (m + y);
...
for (var C = 0; C <= o; C++) 0 === C ? h[C] = -r : C > 0 && C < o ? h[C] = 1 === C ? p * E + Math.min(g, this.sizableWidth) - r : g > 0 ? C === o - 1 ? p + _ + g * (C - 2) - r : p + Math.min(g, this.sizableWidth) + g * (C - 2) - r : p + this.sizableWidth - r : C === o && (h[C] = Math.min(p + this.sizableWidth + v, c) - r);
for (var x = 0; x <= a; x++) 0 === x ? f[x] = -s : x > 0 && x < a ? f[x] = 1 === x ? y * T + Math.min(A, this.sizableHeight) - s : A > 0 ? x === a - 1 ? y + d + (x - 2) * A - s : y + Math.min(A, this.sizableHeight) + (x - 2) * A - s : y + this.sizableHeight - s : x === a && (f[x] = Math.min(y + this.sizableHeight + m, u) - s);
this.updateWorldVerts(t);
};
i.updateWorldVerts = function(t) {
for (var e, i, n, r, s = this._renderData, a = this._local, o = a.x, c = a.y, u = s.vDatas[0], l = this.row, h = this.col, f = t.node._worldMatrix.m, _ = f[0], d = f[1], p = f[4], v = f[5], g = f[12], m = f[13], y = this.floatsPerVert, A = 0, E = 0, T = l; E < T; ++E) {
n = c[E];
r = c[E + 1];
for (var C = 0, x = h; C < x; ++C) {
e = o[C];
i = o[C + 1];
u[A] = e * _ + n * p + g;
u[A + 1] = e * d + n * v + m;
...
if (e) for (var i = t._spriteFrame, n = i._rect, r = i.insetLeft, s = i.insetRight, a = n.width - r - s, o = i.insetTop, c = i.insetBottom, u = n.height - o - c, l = this.row, h = this.col, f = this.hRepeat, _ = this.vRepeat, d = 0, p = 0, v = t.spriteFrame.uv, g = t.spriteFrame.uvSliced, m = t.spriteFrame._rotated, y = this.floatsPerVert, A = this.uvOffset, E = 0, T = l; E < T; ++E) {
p = this.sizableHeight > u ? this.sizableHeight >= E * u ? 1 : _ % 1 : _;
for (var C = 0, x = h; C < x; ++C) {
d = this.sizableWidth > a ? this.sizableWidth >= C * a ? 1 : f % 1 : f;
if (m) {
e[A] = v[0];
e[A + 1] = v[1];
e[A += y] = v[0];
...
0 === C ? e[A] = v[0] : C > 0 && C < h - 1 ? e[A] = g[1].u : C === h - 1 && (e[A] = g[2].u);
0 === E ? e[A + 1] = g[0].v : E > 0 && E < l - 1 ? e[A + 1] = g[4].v : E === l - 1 && (e[A + 1] = g[8].v);
A += y;
0 === C ? e[A] = g[1].u + (g[2].u - g[1].u) * d : C > 0 && C < h - 1 ? e[A] = g[1].u + (g[2].u - g[1].u) * d : C === h - 1 && (e[A] = g[3].u);
0 === E ? e[A + 1] = g[0].v : E > 0 && E < l - 1 ? e[A + 1] = g[4].v : E === l - 1 && (e[A + 1] = g[8].v);
A += y;
0 === C ? e[A] = v[0] : C > 0 && C < h - 1 ? e[A] = g[1].u : C === h - 1 && (e[A] = g[2].u);
0 === E ? e[A + 1] = g[4].v + (g[8].v - g[4].v) * p : E > 0 && E < l - 1 ? e[A + 1] = g[4].v + (g[8].v - g[4].v) * p : E === l - 1 && (e[A + 1] = g[12].v);
e[A += y] = e[A - 2 * y];
e[A + 1] = e[A + 1 - y];
A += y;
}
...
"./CCPath": 164,
"./find": 169,
"./mutable-forward-iterator": 173,
"./profiler/CCProfiler": 176
} ],
172: [ (function(t, e) {
"use strict";
...
var n = e.m, r = i.m, s = t.m, a = n[0], o = n[1], c = n[2], u = n[3], l = n[4], h = n[5], f = n[6], _ = n[7], d = n[8], p = r[0], v = r[1], g = r[2], m = r[3], y = r[4], A = r[5], E = r[6], T = r[7], C = r[8];
s[0] = p * a + v * u + g * f;
s[1] = p * o + v * l + g * _;
s[2] = p * c + v * h + g * d;
s[3] = m * a + y * u + A * f;
...
var n = e.m, r = i.m, s = t.m, a = n[0], o = n[1], c = n[2], u = n[3], l = n[4], h = n[5], f = n[6], _ = n[7], d = n[8], p = r[0], v = r[1], g = r[2], m = r[4], y = r[5], A = r[6], E = r[8], T = r[9], C = r[10];
s[0] = p * a + v * u + g * f;
s[1] = p * o + v * l + g * _;
s[2] = p * c + v * h + g * d;
s[3] = m * a + y * u + A * f;
...
var i = e.m, n = t.m, r = i[0], s = i[1], a = i[2], o = i[3], c = i[4], u = i[5], l = i[6], h = i[7], f = i[8], _ = i[9], d = i[10], p = i[11], v = i[12], g = i[13], m = i[14], y = i[15], A = r * u - s * c, E = r * l - a * c, T = r * h - o * c, C = s * l - a * u, x = s * h - o * u, b = a * h - o * l, S = f * g - _ * v, R = f * m - d * v, w = f * y - p * v, M = _ * m - d * g, I = _ * y - p * g, D = d * y - p * m, O = A * D - E * I + T * M + C * w - x * R + b * S;
if (!O) return t;
O = 1 / O;
n[0] = (u * D - l * I + h * M) * O;
n[1] = (l * w - c * D - h * R) * O;
...
var i = t.m, n = e.m, s = i[0], a = i[1], o = i[2], c = i[3], u = i[4], l = i[5], h = i[6], f = i[7], _ = i[8], d = n[0], p = n[1], v = n[2], g = n[3], m = n[4], y = n[5], A = n[6], E = n[7], T = n[8];
...
var h = 0, f = 0, _ = 0, d = 0, p = 0, v = 0, g = 0, m = 0, y = 0, A = 0, E = 0, T = 0, C = 0, x = 0, b = 0, S = 0, R = (function(t) {
l(i, t);
var e = i.prototype;
e.mul = function(t, e) {
...
b = i[14];
S = i[15];
var n = h * v - f * p, r = h * g - _ * p, s = h * m - d * p, a = f * g - _ * v, o = f * m - d * v, c = _ * m - d * g, u = y * x - A * C, l = y * b - E * C, R = y * S - T * C, w = A * b - E * x, M = A * S - T * x, I = E * S - T * b, D = n * I - r * M + s * w + a * R - o * l + c * u;
if (0 === D) return null;
D = 1 / D;
var O = t.m;
O[0] = (v * I - g * M + m * w) * D;
...
b = e[14];
S = e[15];
return (h * v - f * p) * (E * S - T * b) - (h * g - _ * p) * (A * S - T * x) + (h * m - d * p) * (A * b - E * x) + (f * g - _ * v) * (y * S - T * C) - (f * m - d * v) * (y * b - E * C) + (_ * m - d * g) * (y * x - A * C);
};
...
n[8] = a * h + o * p + c * y + u * C;
n[9] = a * f + o * v + c * A + u * x;
n[10] = a * _ + o * g + c * E + u * b;
n[11] = a * d + o * m + c * T + u * S;
a = s[12];
o = s[13];
c = s[14];
u = s[15];
n[12] = a * h + o * p + c * y + u * C;
n[13] = a * f + o * v + c * A + u * x;
n[14] = a * _ + o * g + c * E + u * b;
n[15] = a * d + o * m + c * T + u * S;
return t;
};
...
a[13] = f * n + v * r + A * s + o[13];
a[14] = _ * n + g * r + E * s + o[14];
a[15] = d * n + m * r + T * s + o[15];
}
return t;
};
...
E = x[10];
T = x[11];
var b = r * r * C + l, S = s * r * C + a * u, R = a * r * C - s * u, w = r * s * C - a * u, M = s * s * C + l, I = a * s * C + r * u, D = r * a * C + s * u, O = s * a * C - r * u, L = a * a * C + l, N = t.m;
N[0] = h * b + p * S + y * R;
N[1] = f * b + v * S + A * R;
N[2] = _ * b + g * S + E * R;
N[3] = d * b + m * S + T * R;
...
var i = e.m, n = M.m, r = n[0] = i[0], s = n[1] = i[1], a = n[2] = i[2], o = n[3] = i[4], u = n[4] = i[5], l = n[5] = i[6], h = n[6] = i[8], f = n[7] = i[9], _ = n[8] = i[10];
...
a.default.fromMat3(e, M);
s.default.set(i, r[12], r[13], r[14]);
};
i.fromRTS = function(t, e, i, n) {
var r = e.x, s = e.y, a = e.z, o = e.w, c = r + r, u = s + s, l = a + a, h = r * c, f = r * u, _ = r * l, d = s * u, p = s * l, v = a * l, g = o * c, m = o * u, y = o * l, A = n.x, E = n.y, T = n.z, C = t.m;
C[0] = (1 - (d + v)) * A;
C[1] = (f + y) * A;
C[2] = (_ - m) * A;
C[3] = 0;
...
var s = e.x, a = e.y, o = e.z, c = e.w, u = s + s, l = a + a, h = o + o, f = s * u, _ = s * l, d = s * h, p = a * l, v = a * h, g = o * h, m = c * u, y = c * l, A = c * h, E = n.x, T = n.y, C = n.z, x = r.x, b = r.y, S = r.z, R = t.m;
R[0] = (1 - (p + g)) * E;
R[1] = (_ + A) * E;
R[2] = (d - y) * E;
R[3] = 0;
...
R[10] = (1 - (f + p)) * C;
R[11] = 0;
R[12] = i.x + x - (R[0] * x + R[4] * b + R[8] * S);
R[13] = i.y + b - (R[1] * x + R[5] * b + R[9] * S);
R[14] = i.z + S - (R[2] * x + R[6] * b + R[10] * S);
R[15] = 1;
return t;
};
...
var r = e.x, s = e.y, a = e.z, o = n.x, c = n.y, u = n.z, l = r - i.x, h = s - i.y, f = a - i.z, _ = 1 / Math.sqrt(l * l + h * h + f * f), d = c * (f *= _) - u * (h *= _), p = u * (l *= _) - o * f, v = o * h - c * l, g = h * (v *= _ = 1 / Math.sqrt(d * d + p * p + v * v)) - f * (p *= _), m = f * (d *= _) - l * v, y = l * p - h * d, A = t.m;
A[0] = d;
A[1] = g;
A[2] = l;
A[3] = 0;
...
var w = new s.default(), M = new c.default();
...
var i = e[3], n = e[4], r = e[5], s = e[6], a = i + i, o = n + n, c = r + r, u = i * a, l = i * o, h = i * c, f = n * o, _ = n * c, d = r * c, p = s * a, v = s * o, g = s * c, m = e[7], y = e[8], A = e[9], E = t.m;
E[0] = (1 - (f + d)) * m;
E[1] = (l + g) * m;
E[2] = (h - v) * m;
E[3] = 0;
...
"../core/assets/CCAsset": 48,
"../core/assets/CCSpriteFrame": 60
} ],
202: [ (function(t, e) {
"use strict";
var i, n, r, s, a, o, c, u, l, h, f, _, d, p, v, g, m, y, A, E, T, C, x, b, S, R, w, M, I, D, O, L, N, P, F, B, z, U, k, V, W, G;
(function(t) {
...
"../../core/value-types/value-type": 195,
"../enums": 206,
"../gfx": 207
} ],
205: [ (function(t, e, i) {
...
"../core/assets/CCTexture2D": 63,
"../core/value-types": 187,
"./enums": 206,
...
"./cocos2d/particle/CCParticleAsset": 201,
"./cocos2d/tilemap": void 0,
"./cocos2d/tilemap/CCTiledMapAsset": 210,
